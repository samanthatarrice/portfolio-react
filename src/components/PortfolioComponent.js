                  ...
                  <div className="row d-flex align-items-center">
                    <div className="app-view-container col-md-6 me-2-sm pb-4 pb-md-0">
                      <div className="d-flex justify-content-center" >
                        <img src="/images/mobile-black.png" alt="Mobile phone outline." className="mobile-phone w-50"/>
                        <div className="app-video-container w-50">
                          <video className="app-video" controls>
                            <source src="images/Mono_Log-video.mp4" type="video/mp4" />
                            <source src="images/Mono_Log-vide.ogg" type="video/ogg" />
                    ...
                    <div className="col ms-sm-2 mt-4 mt-sm-0">
                      ...
                      <p>I am currently working on this final project to showcase all I have learned in NuCamp's Full Stack Bootcamp. I created the wireframe using Figma, and set up the React Native app using Expo. For navigation I used React Navigation, and for the elements I am using some of React's preset elements as well as some elements from React-Native-Elements. So far, the user can log journal entries to another page which shows all the journal entries. They can also log their mood and upload images from their gallery. I plan to implement more features, such as a calendar that keeps track of the days they logged an entry and shows data trends about their mood. I also plan on adding the ability for a user to log on to the app when I learn more about backend programming.</p>
