    ...
    return (
        <section id="about">
          ...
          <div className="container mb-5">
                ...
                <div className="card experience-card border-0 p-2">
                  <div className="card-body p-4 p-md-5">
                    ...
                    <ul className="experience-item card-text my-3 ps-3 ps-md-5">
                      ...
                      <p>My husband and I moved to Salvador, Bahia, Brazil to teach at this IB International school. </p>
                    </ul>
                    <ul className="experience-item card-text my-3 ps-3 ps-md-5">
            ...
            <div className="row my-0 my-sm-4">
              <div className="col">
                <div className="card resume-card border-0 p-2">
                  <div className="card-body p-4 p-md-5">
